...
#include "AbilitySystemSetupCharacter.generated.h"
...
UCLASS()
class ABILITYSYSTEMSETUP_API AAbilitySystemSetupCharacter : public ACharacter, public IAbilitySystemInterface, public IAbilitySystemSetupInterface
{
	GENERATED_BODY()
...
public:
	AAbilitySystemSetupCharacter(const FObjectInitializer& ObjectInitializer);
...
private:
	...
	/**
	 * This is used if an AIController is possessing. However, it is also used as a placeholder ASC for before the Player possesses this Character (so we can give Abilities and stuff).
