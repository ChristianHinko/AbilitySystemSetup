...
UASSAbilitySystemComponent* UAT_PlayMontageAndWaitForEvent::GetTargetASC()
{
	return Cast<UASSAbilitySystemComponent>(AbilitySystemComponent);
}
...
void UAT_PlayMontageAndWaitForEvent::Activate()
{
	...
	UASSAbilitySystemComponent* GDAbilitySystemComponent = GetTargetASC();
